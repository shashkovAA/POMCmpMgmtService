...
public class StopActiveJob extends POMWebServiceOperation{
	...
	public 	StopActiveJob(ArrayList<String> params){
		this.params = params;
        ...
        if (isSetProceedStopCampaignFlag) {
    		...
    		String	stopJobResult = parseResponseForStopJob(response);
